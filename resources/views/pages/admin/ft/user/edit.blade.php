...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{route('datadiri.update', $item->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tlahirDiri" name="tlahirDiri" placeholder="Tempat Lahir..." value="{{$item->tlahirDiri}}">

                        <label for="tgllahirDiri" class="mt-3">Tanggal Lahir</label>
                        <input type="date" class="form-control" id="tgllahirDiri" name="tgllahirDiri" placeholder="Tanggal Lahir..." value="{{$item->tgllahirDiri}}">

                        <label for="mulai_bekerja" class="mt-3">Mulai Bekerja</label>
                        <input type="date" class="form-control" id="mulai_bekerja" name="mulai_bekerja" placeholder="Mulai Bekerja..." value="{{$item->mulai_bekerja}}">

                        <label for="jabatan" class="mt-3">Jabatan Sekarang</label>
                        <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan Sekarang..." value="{{$item->jabatan}}">
                        ...
                        <input type="text" class="form-control" id="telp" name="telp" placeholder="Telephone..." value="{{$item->telp}}">

                        <label for="hp" class="mt-3">Hp</label>
                        <input type="text" class="form-control" id="hp" name="hp" placeholder="Hp..." value="{{$item->hp}}">
                    ...
                    <button type="submit" class="btn btn-success mt-3" style="margin-top: 10px">Simpan</button>
                    <a href="{{route('datadiri.show', $item->id)}}" class="btn btn-secondary float-right">Batal</a>
                </form>
            </div>
        </div>
